...
function appAdd(command) {
    return exports.sdk.addApp(command.appName)
        .then(function (app) {
...
function addCollaborator(command) {
    ...
    return exports.sdk.addCollaborator(command.appName, command.email)
        .then(function () {
        exports.log("Successfully added \"" + command.email + "\" as a collaborator to the app \"" + command.appName + "\".");
    });
}
...
function initiateExternalAuthenticationAsync(action, serverUrl) {
    var message = "A browser is being launched to authenticate your account. Follow the instructions " +
...
function getReactNativeProjectAppVersion(command, projectName) {
    ...
    var isValidVersion = function (version) { return !!semver.valid(version) || /^\d+\.\d+$/.test(version); };
    ...
    if (command.platform === "ios") {
        ...
        return g2js.parseFile(buildGradlePath)
            ...
            var appVersion = buildGradle.android.defaultConfig.versionName.replace(/"/g, "").trim();
            ...
            var propertiesFile = knownLocations.find(fileExists);
...
exports.release = function (command) {
    ...
    return getPackageFilePromise
        ...
        return exports.sdk.isAuthenticated(true)
            ...
            return exports.sdk.release(command.appName, command.deploymentName, file.path, command.appStoreVersion, updateMetadata, uploadProgress);
        })
            .then(function () {
...
exports.releaseCordova = function (command) {
    ...
    var cordovaCommand = command.build ? "build" : "prepare";
...
exports.releaseReact = function (command) {
    ...
    var outputFolder = path.join(os.tmpdir(), "CodePush");
    ...
    return appVersionPromise
        ...
        .then(function () { return exports.runReactNativeBundleCommand(bundleName, command.development || false, entryFile, outputFolder, platform, command.sourcemapOutput); })
        .then(function () {
        exports.log(chalk.cyan("\nReleasing update contents to CodePush:\n"));
        return exports.release(releaseCommand);
    })
        .then(function () { return deleteFolder(outputFolder); })
        .catch(function (err) {
...
exports.runReactNativeBundleCommand = function (bundleName, development, entryFile, outputFolder, platform, sourcemapOutput) {
...
function getYargsBooleanOrNull(value) {
