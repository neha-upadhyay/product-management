...
var SdkStub = (function () {
    ...
    SdkStub.prototype.addApp = function (name) {
        return Q({
            name: name
        });
    };
    ...
    SdkStub.prototype.addDeployment = function (appId, name) {
        return Q({
            name: name,
            key: "6"
        });
    };
    SdkStub.prototype.clearDeploymentHistory = function (appId, deployment) {
        return Q(null);
    };
    ...
    SdkStub.prototype.getDeployments = function (appId) {
        return Q([{
                name: "Production",
                key: "6"
            }, {
    ...
    SdkStub.prototype.getDeploymentHistory = function (appId, deploymentId) {
        return Q([
            {
                description: null,
                appVersion: "1.0.0",
    ...
    SdkStub.prototype.getDeploymentMetrics = function (appId, deploymentId) {
        return Q({
            "1.0.0": {
                active: 123
            },
    ...
    SdkStub.prototype.release = function (appId, deploymentId) {
        return Q("Successfully released");
    };
    SdkStub.prototype.removeAccessKey = function (accessKeyId) {
        return Q(null);
    };
    SdkStub.prototype.removeApp = function (appId) {
        return Q(null);
    };
    SdkStub.prototype.removeCollaborator = function (name, email) {
        return Q(null);
    };
    SdkStub.prototype.removeDeployment = function (appId, deployment) {
        return Q(null);
    };
    ...
    SdkStub.prototype.renameDeployment = function (appId, deployment) {
        return Q(null);
    };
    return SdkStub;
})();
...
describe("CLI", function () {
    ...
    it("accessKeyPatch updates access key with new ttl", function (done) {
        var ttl = 10000;
        var command = {
            type: cli.CommandType.accessKeyPatch,
            oldName: "Test name",
    ...
    it("accessKeyPatch updates access key with new name and ttl", function (done) {
        var ttl = 10000;
        var command = {
            type: cli.CommandType.accessKeyPatch,
            oldName: "Test name",
